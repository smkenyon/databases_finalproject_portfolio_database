...
<html>
	<head>
		<title>Investor Remove - Kenyon Portfolio Database</title>
		<meta charset="utf-8" />
				...
				<section id="main" class="container">
					<?php
						...
						if($result)
						{
							...
							// update Portfolios_Assets
							$sql4 = "DELETE FROM Portfolios_Assets WHERE portfolio_asset_id='$portfolio_asset_id';";
							$result4 = mysqli_query($db_server, $sql4);

							if($result4) echo "<p>Successfully deleted position and updated database</p>";
							else echo "<p>Failed to delete position. Please try again</p>";
						}

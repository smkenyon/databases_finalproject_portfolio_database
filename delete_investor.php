...
<html>
	<head>
		<title>Delete Investor - Kenyon Portfolio Database</title>
		<meta charset="utf-8" />
		...
		<div id="page-wrapper">
			...
			<!-- Header -->
				...
				<?php
					...
					if($result) echo "<p>Successfully deleted investor</p>";
					else echo "<p>Failed to delete investor to the database</p>";
				?>

...
<html>
	<head>
		<title>Create Asset - Kenyon Portfolio Database</title>
		<meta charset="utf-8" />
		...
		<div id="page-wrapper">
			...
			<!-- Header -->
				...
				<?php
					...
					if($result_cid)
					{
						$sql = "INSERT INTO Assets (asset_name, symbol, category_id) VALUES ('$asset', '$symbol', '$category_id');";
						$result = mysqli_query($db_server, $sql);
						if($result) echo "<p>Successfully added asset $asset $symbol $category_name to the database</p>";
						else echo "<p>Failed to add asset to the database</p>";
					}
				?>

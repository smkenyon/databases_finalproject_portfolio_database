...
<html>
	<head>
		<title>Delete Fund - Kenyon Portfolio Database</title>
		<meta charset="utf-8" />
		...
		<div id="page-wrapper">
			...
			<!-- Header -->
				...
				<?php
					...
					$sql = "DELETE FROM Portfolio_Managers WHERE pm_id = '$pm_id';";
					$result = mysqli_query($db_server, $sql);
					if($result) echo "<p>Successfully deleted fund</p>";
					else echo "<p>Failed to delete fund from the database</p>";
					
				?>
				<ul class="actions special">
						<li><a href="admin_delete.php" class="button primary">Return</a></li>
				</ul>
        		</section>
        <!-- Footer -->
                <footer id="footer">

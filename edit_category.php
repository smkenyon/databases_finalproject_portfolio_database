...
<html>
	<head>
		<title>Edit Category - Kenyon Portfolio Database</title>
		<meta charset="utf-8" />
		...
		<div id="page-wrapper">
			...
			<!-- Header -->
				...
				<?php
					...
					if($result) echo "<p>Successfully edited category '$category_name' to the database</p>";
					else echo "<p>Failed to edit category to the database</p>";

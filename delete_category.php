...
<html>
	<head>
		<title>Delete Category - Kenyon Portfolio Database</title>
		<meta charset="utf-8" />
		...
		<div id="page-wrapper">
			...
			<!-- Header -->
				...
				<?php
					...
					if($result) echo "<p>Successfully deleted category</p>";
					else echo "<p>Failed to delete category from the database</p>";

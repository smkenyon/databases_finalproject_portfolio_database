...
<html>
	<head>
		<title>Investor Edit Position - Kenyon Portfolio Database</title>
		<meta charset="utf-8" />
			...
			<!-- Header -->
				...
				<section id="main" class="container">
                    <header>
                        ...
                        <p>Complete the form to edit the position #<?php foreach($_POST as $key=>$value) ${$key}=$value; $trade_id = $_POST['trade_id']; echo "$trade_id";?></p>
                        </br></br>
					</header>
                    <!-- Add Position Form -->
                    <form method="post" action="investor_edit_execute.php">
						...
						<div class="col-6 col-12-mobilep">
							...
							<input type="hidden" name="trade_id" id="trade_id" value=<?php foreach($_POST as $key=>$value) ${$key}=$value; $trade_id = $_POST['trade_id']; echo $trade_id;?> />
                            <div class="col-12">
                                <ul class="actions">
